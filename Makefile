...
submit:
	...
	make -C challenge-aido1_LF1-template-tensorflow submit
	make -C challenge-aido1_LF1-template-random submit

	make -C challenge-aido1_amod1-template-python submit
	make -C challenge-aido1_amod1-template-java submit
